...
1. **Focused study desk:** bàn học yên tĩnh, canvas đọc lớn, panel AI gọn.
2. **Evidence-first workspace:** citation, nguồn và đoạn văn liên quan là trung tâm của bố cục.
3. **Progressive learning hub:** nhấn mạnh tiến độ, câu hỏi tiếp theo và hành động học kế tiếp.

Mỗi concept cần có header/sidebar, vùng tài liệu, vùng Q&A, ít nhất hai message của hội thoại, citation card, input câu hỏi và trạng thái loading hoặc empty. Dùng dữ liệu mẫu bằng tiếng Việt, typography có chủ đích và responsive behavior ở mobile.

## Ràng buộc kỹ thuật

- Có thể dùng Tailwind CSS qua CDN cho prototype single-file.
- Không dùng framework JavaScript bắt buộc phải build.
